...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		desktop: "assets/images/DesktopWallpaper/landscape_desktop.avif",
		// 移动背景图片（支持单张或多张随机）
		// mobile: "assets/images/MobileWallpaper/m1.avif",
		mobile: "assets/images/MobileWallpaper/landscape_mobile.avif",
		// 背景视频播放地址
	...
	common: {
		...
		homeText: {
			...
			titleSize: "4.5rem",
			// 主页横幅副标题
			subtitle: "Placing Wards in the Fog of Knowledge",
			// 主页横幅副标题字体大小
			subtitleSize: "1.5rem",
			typewriter: {
				// 是否启用打字机效果
